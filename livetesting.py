...
def printsentiment():
    ...
    model = pickle.load(open("result/mlp_classifierMyDataSet.model", "rb"))
    ...
    features = extract_feature(filename, mfcc=True, chroma=True, mel=True,contrast=False,tonnetz=False).reshape(1, -1)
    #print(features)
